"""
Unit Test for merge_k_soted_linked_lists_divide_and_conquer
"""
from unittest import TestCase

from common.linked_list import LinkedList
from common.linked_list import Node
from problems.linked_list.merge_k_soted_linked_lists_divide_and_conquer import MergeKSortedLinkedListsDivideAndConquer


class TestMergeKSortedLinkedListsDivideAndConquer(TestCase):
    """
    Unit test for MergeKSortedLinkedListsDivideAndConquer
    """
    ...
    def test_solve(self):
        ...
        merge_k_linked_lists_problem = MergeKSortedLinkedListsDivideAndConquer(input_linked_lists_list)
